...
from backend.services.economic_reconciliation.bank_caja_rural_parser_service import (  # noqa: E402
    cents_to_eur,
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Diagnóstico de exportación bancaria Caja Rural."
    )
    ...
    report = diagnose_caja_rural_bank_file(args.file)

    print("")
    print("== Diagnóstico Banco Caja Rural ==")
    ...
    print("")
    print("Política:")
    print("  Caja Rural se diagnostica como movimiento bancario bruto. No crea cobros, facturas ni vínculos automáticos.")
