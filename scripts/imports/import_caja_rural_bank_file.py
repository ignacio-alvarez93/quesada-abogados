...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Importa exportación bancaria Caja Rural a staging económico."
    )
    ...
    result = import_caja_rural_bank_file(args.file, db_path=args.db)

    print("")
    print("== Importación Banco Caja Rural ==")
    print(f"DB: {args.db}")
